    ...
    def __init__(self, name='', *, arrow=None):
        ...
        if name is None:
            ...
            if self._is_abbreviation(name):
                ...
                if name in constants._symbol_to_semitones:
                    semitones = constants._symbol_to_semitones[name]
                else:
                    ...
                    if name == '+':
                        ...
                        semitone -= 1.25
            elif name in constants._name_to_abbreviation:
                name = constants._name_to_abbreviation[name]
                semitones = constants._accidental_abbreviation_to_semitones[name]
            else:
